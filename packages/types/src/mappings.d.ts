...
declare module "@moonlight-mod/wp/discord/Constants" {
  ...
  export const FriendSourceFlags: MappedModules["discord/Constants"]["FriendSourceFlags"];
  ...
  export const SpoilerRenderSetting: MappedModules["discord/Constants"]["SpoilerRenderSetting"];
...
declare module "@moonlight-mod/wp/discord/actions/UserActionCreators" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const acceptAgreements: MappedModules["discord/actions/UserActionCreators"]["acceptAgreements"];
  export const fetchCurrentUser: MappedModules["discord/actions/UserActionCreators"]["fetchCurrentUser"];
  export const fetchProfile: MappedModules["discord/actions/UserActionCreators"]["fetchProfile"];
  export const getUser: MappedModules["discord/actions/UserActionCreators"]["getUser"];
  export const setFlag: MappedModules["discord/actions/UserActionCreators"]["setFlag"];
}

declare module "@moonlight-mod/wp/discord/actions/UserProfileModalActionCreators" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const openUserProfileModal: MappedModules["discord/actions/UserProfileModalActionCreators"]["openUserProfileModal"];
  export const closeUserProfileModal: MappedModules["discord/actions/UserProfileModalActionCreators"]["closeUserProfileModal"];
}
...
declare module "@moonlight-mod/wp/discord/components/common/Select" {
  import { MappedModules } from "@moonlight-mod/mappings";
...
declare module "@moonlight-mod/wp/discord/design/components/Avatar/web/Avatar" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/design/components/Avatar/web/Avatar"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/design/components/Avatar/web/AvatarConstants" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const Sizes: MappedModules["discord/design/components/Avatar/web/AvatarConstants"]["Sizes"];
  export const SizeSpec: MappedModules["discord/design/components/Avatar/web/AvatarConstants"]["SizeSpec"];
}
...
declare module "@moonlight-mod/wp/discord/design/components/Button/web/TextButton" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/design/components/Button/web/TextButton"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/design/components/Clickable/web/Clickable" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/design/components/Clickable/web/Clickable"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/design/components/Dialog/web/Dialog" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/design/components/Dialog/web/Dialog"]["default"];
  export default _default;
  export const DialogContext: MappedModules["discord/design/components/Dialog/web/Dialog"]["DialogContext"];
}

declare module "@moonlight-mod/wp/discord/design/components/Divider/Divider" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/design/components/Divider/Divider"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/design/components/Form/web/Field" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/design/components/Form/web/Field"]["default"];
  export default _default;
  export const splitFieldProps: MappedModules["discord/design/components/Form/web/Field"]["splitFieldProps"];
}

declare module "@moonlight-mod/wp/discord/design/components/Form/web/FieldSet" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/design/components/Form/web/FieldSet"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/design/components/Form/web/FieldSet.css" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const fieldset: MappedModules["discord/design/components/Form/web/FieldSet.css"]["fieldset"];
  export const description: MappedModules["discord/design/components/Form/web/FieldSet.css"]["description"];
  export const legend: MappedModules["discord/design/components/Form/web/FieldSet.css"]["legend"];
}

declare module "@moonlight-mod/wp/discord/design/components/Heading/Heading" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/design/components/Heading/Heading"]["default"];
  export default _default;
}
...
declare module "@moonlight-mod/wp/discord/design/components/Notice/web/Notice" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const Notice: MappedModules["discord/design/components/Notice/web/Notice"]["Notice"];
  export const NoticeCloseButton: MappedModules["discord/design/components/Notice/web/Notice"]["NoticeCloseButton"];
  export const PrimaryCTANoticeButton: MappedModules["discord/design/components/Notice/web/Notice"]["PrimaryCTANoticeButton"];
...
declare module "@moonlight-mod/wp/discord/design/components/Switch/web/VoidSwitch" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/design/components/Switch/web/VoidSwitch"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/design/components/TabBar/TabBar" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/design/components/TabBar/TabBar"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/design/components/Text/Text" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/design/components/Text/Text"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/design/components/ThemeContextProvider/ThemeContext" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const createThemedContext: MappedModules["discord/design/components/ThemeContextProvider/ThemeContext"]["createThemedContext"];
  export const useThemeContext: MappedModules["discord/design/components/ThemeContextProvider/ThemeContext"]["useThemeContext"];
  export const FALLBACK_THEME_CONTEXT_VALUE: MappedModules["discord/design/components/ThemeContextProvider/ThemeContext"]["FALLBACK_THEME_CONTEXT_VALUE"];
  export const ThemeContext: MappedModules["discord/design/components/ThemeContextProvider/ThemeContext"]["ThemeContext"];
  export const UseThemeContext: MappedModules["discord/design/components/ThemeContextProvider/ThemeContext"]["UseThemeContext"];
}

declare module "@moonlight-mod/wp/discord/design/components/Toast/web/Toast" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const createToast: MappedModules["discord/design/components/Toast/web/Toast"]["createToast"];
  export const Toast: MappedModules["discord/design/components/Toast/web/Toast"]["Toast"];
}

declare module "@moonlight-mod/wp/discord/design/components/Toast/web/ToastAPI" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const useToastStore: MappedModules["discord/design/components/Toast/web/ToastAPI"]["useToastStore"];
  export const showToast: MappedModules["discord/design/components/Toast/web/ToastAPI"]["showToast"];
  export const popToast: MappedModules["discord/design/components/Toast/web/ToastAPI"]["popToast"];
}

declare module "@moonlight-mod/wp/discord/design/components/Toast/web/ToastConstants" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const ToastType: MappedModules["discord/design/components/Toast/web/ToastConstants"]["ToastType"];
  export const ToastPosition: MappedModules["discord/design/components/Toast/web/ToastConstants"]["ToastPosition"];
  export const TOAST_DEFAULT_OPTIONS: MappedModules["discord/design/components/Toast/web/ToastConstants"]["TOAST_DEFAULT_OPTIONS"];
}

declare module "@moonlight-mod/wp/discord/design/components/Tooltip/web/VoidTooltip" {
  import { MappedModules } from "@moonlight-mod/mappings";
...
declare module "@moonlight-mod/wp/discord/intl" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const intl: MappedModules["discord/intl"]["intl"];
  export const t: MappedModules["discord/intl"]["t"];
}
...
declare module "@moonlight-mod/wp/discord/modules/chat/web/ImageHoverButtons.css" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const hoverButton: MappedModules["discord/modules/chat/web/ImageHoverButtons.css"]["hoverButton"];
  export const sizer: MappedModules["discord/modules/chat/web/ImageHoverButtons.css"]["sizer"];
  export const nonMediaMosaicItem: MappedModules["discord/modules/chat/web/ImageHoverButtons.css"]["nonMediaMosaicItem"];
  export const hoverButtonGroup: MappedModules["discord/modules/chat/web/ImageHoverButtons.css"]["hoverButtonGroup"];
}
...
declare module "@moonlight-mod/wp/discord/modules/icons/web/ArrowAngleLeftUpIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/ArrowAngleLeftUpIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/ArrowAngleRightUpIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/ArrowAngleRightUpIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/ArrowsUpDownIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/ArrowsUpDownIcon"]["default"];
  export default _default;
}
...
declare module "@moonlight-mod/wp/discord/modules/icons/web/ChannelListIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/ChannelListIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/ChevronSmallDownIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/ChevronSmallDownIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/ChevronSmallUpIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/ChevronSmallUpIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/CircleInformationIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/CircleInformationIcon"]["default"];
  export default _default;
}
...
declare module "@moonlight-mod/wp/discord/modules/icons/web/CopyIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/CopyIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/DownloadIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/DownloadIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/FullscreenEnterIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/FullscreenEnterIcon"]["default"];
  export default _default;
}
...
declare module "@moonlight-mod/wp/discord/modules/icons/web/HeartIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/HeartIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/LinkIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/LinkIcon"]["default"];
  export default _default;
}
...
declare module "@moonlight-mod/wp/discord/modules/icons/web/MinusIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/MinusIcon"]["default"];
  export default _default;
}
...
declare module "@moonlight-mod/wp/discord/modules/icons/web/PlusLargeIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/PlusLargeIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/RetryIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/RetryIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/ScienceIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/ScienceIcon"]["default"];
  export default _default;
}
...
declare module "@moonlight-mod/wp/discord/modules/icons/web/StarIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/StarIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/TrashIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/TrashIcon"]["default"];
  export default _default;
}
...
declare module "@moonlight-mod/wp/discord/modules/icons/web/WarningIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/WarningIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/WindowLaunchIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/WindowLaunchIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/WindowTopOutlineIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/WindowTopOutlineIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/XLargeIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/XLargeIcon"]["default"];
  export default _default;
}

declare module "@moonlight-mod/wp/discord/modules/icons/web/XSmallIcon" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/modules/icons/web/XSmallIcon"]["default"];
  export default _default;
}
...
declare module "@moonlight-mod/wp/discord/modules/media_viewer/web/components/openMediaModal" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const openMediaModal: MappedModules["discord/modules/media_viewer/web/components/openMediaModal"]["openMediaModal"];
  export const MEDIA_MODAL_KEY: MappedModules["discord/modules/media_viewer/web/components/openMediaModal"]["MEDIA_MODAL_KEY"];
}
...
declare module "@moonlight-mod/wp/discord/modules/user_settings/UserSettings" {
  ...
  export const ActivityJoiningRestrictedGuildIds: MappedModules["discord/modules/user_settings/UserSettings"]["ActivityJoiningRestrictedGuildIds"];
  export const ActivityRestrictedGuildIds: MappedModules["discord/modules/user_settings/UserSettings"]["ActivityRestrictedGuildIds"];
  export const AfkTimeout: MappedModules["discord/modules/user_settings/UserSettings"]["AfkTimeout"];
  export const AllowActivityPartyPrivacyFriends: MappedModules["discord/modules/user_settings/UserSettings"]["AllowActivityPartyPrivacyFriends"];
  export const AllowActivityPartyPrivacyVoiceChannel: MappedModules["discord/modules/user_settings/UserSettings"]["AllowActivityPartyPrivacyVoiceChannel"];
  export const AllowGameFriendDmsInDiscord: MappedModules["discord/modules/user_settings/UserSettings"]["AllowGameFriendDmsInDiscord"];
  export const AllowVoiceRecording: MappedModules["discord/modules/user_settings/UserSettings"]["AllowVoiceRecording"];
  export const AlwaysDeliver: MappedModules["discord/modules/user_settings/UserSettings"]["AlwaysDeliver"];
  export const AlwaysPreviewVideo: MappedModules["discord/modules/user_settings/UserSettings"]["AlwaysPreviewVideo"];
  export const AnimateEmoji: MappedModules["discord/modules/user_settings/UserSettings"]["AnimateEmoji"];
  export const AnimateStickers: MappedModules["discord/modules/user_settings/UserSettings"]["AnimateStickers"];
  export const ClientThemeSettings: MappedModules["discord/modules/user_settings/UserSettings"]["ClientThemeSettings"];
  export const ConvertEmoticons: MappedModules["discord/modules/user_settings/UserSettings"]["ConvertEmoticons"];
  export const CustomStatus: MappedModules["discord/modules/user_settings/UserSettings"]["CustomStatus"];
  export const DefaultGuildsActivityRestricted: MappedModules["discord/modules/user_settings/UserSettings"]["DefaultGuildsActivityRestricted"];
  export const DefaultGuildsRestricted: MappedModules["discord/modules/user_settings/UserSettings"]["DefaultGuildsRestricted"];
  export const DefaultGuildsRestrictedV2: MappedModules["discord/modules/user_settings/UserSettings"]["DefaultGuildsRestrictedV2"];
  export const DefaultMessageRequestRestricted: MappedModules["discord/modules/user_settings/UserSettings"]["DefaultMessageRequestRestricted"];
  export const DeveloperMode: MappedModules["discord/modules/user_settings/UserSettings"]["DeveloperMode"];
  export const DisableGamesTab: MappedModules["discord/modules/user_settings/UserSettings"]["DisableGamesTab"];
  export const DisableStreamPreviews: MappedModules["discord/modules/user_settings/UserSettings"]["DisableStreamPreviews"];
  export const DmSpamFilterV2: MappedModules["discord/modules/user_settings/UserSettings"]["DmSpamFilterV2"];
  export const DropsOptedOut: MappedModules["discord/modules/user_settings/UserSettings"]["DropsOptedOut"];
  export const EmojiPickerCollapsedSections: MappedModules["discord/modules/user_settings/UserSettings"]["EmojiPickerCollapsedSections"];
  export const EnableTtsCommand: MappedModules["discord/modules/user_settings/UserSettings"]["EnableTtsCommand"];
  export const ExplicitContentFilter: MappedModules["discord/modules/user_settings/UserSettings"]["ExplicitContentFilter"];
  export const ExplicitContentSettings: MappedModules["discord/modules/user_settings/UserSettings"]["ExplicitContentSettings"];
  export const ExpressionSuggestionsEnabled: MappedModules["discord/modules/user_settings/UserSettings"]["ExpressionSuggestionsEnabled"];
  export const FamilyCenterEnabledV2: MappedModules["discord/modules/user_settings/UserSettings"]["FamilyCenterEnabledV2"];
  export const FocusModeExpiresAtMs: MappedModules["discord/modules/user_settings/UserSettings"]["FocusModeExpiresAtMs"];
  export const FriendSourceFlags: MappedModules["discord/modules/user_settings/UserSettings"]["FriendSourceFlags"];
  export const GameActivityNotifications: MappedModules["discord/modules/user_settings/UserSettings"]["GameActivityNotifications"];
  export const GifAutoPlay: MappedModules["discord/modules/user_settings/UserSettings"]["GifAutoPlay"];
  export const HideLegacyUsername: MappedModules["discord/modules/user_settings/UserSettings"]["HideLegacyUsername"];
  export const IgnoreProfileSpeedbumpDisabled: MappedModules["discord/modules/user_settings/UserSettings"]["IgnoreProfileSpeedbumpDisabled"];
  export const InAppFeedbackStates: MappedModules["discord/modules/user_settings/UserSettings"]["InAppFeedbackStates"];
  export const IncludeSoundmojiInAutocomplete: MappedModules["discord/modules/user_settings/UserSettings"]["IncludeSoundmojiInAutocomplete"];
  export const IncludeStickersInAutocomplete: MappedModules["discord/modules/user_settings/UserSettings"]["IncludeStickersInAutocomplete"];
  export const InlineAttachmentMedia: MappedModules["discord/modules/user_settings/UserSettings"]["InlineAttachmentMedia"];
  export const InlineEmbedMedia: MappedModules["discord/modules/user_settings/UserSettings"]["InlineEmbedMedia"];
  export const InstallShortcutDesktop: MappedModules["discord/modules/user_settings/UserSettings"]["InstallShortcutDesktop"];
  export const InstallShortcutStartMenu: MappedModules["discord/modules/user_settings/UserSettings"]["InstallShortcutStartMenu"];
  export const KeywordFilterSettings: MappedModules["discord/modules/user_settings/UserSettings"]["KeywordFilterSettings"];
  export const LastReceivedChangelogId: MappedModules["discord/modules/user_settings/UserSettings"]["LastReceivedChangelogId"];
  export const MessageDisplayCompact: MappedModules["discord/modules/user_settings/UserSettings"]["MessageDisplayCompact"];
  export const MessageRequestRestrictedGuildIds: MappedModules["discord/modules/user_settings/UserSettings"]["MessageRequestRestrictedGuildIds"];
  export const NonSpamRetrainingOptIn: MappedModules["discord/modules/user_settings/UserSettings"]["NonSpamRetrainingOptIn"];
  export const NotificationCenterAckedBeforeId: MappedModules["discord/modules/user_settings/UserSettings"]["NotificationCenterAckedBeforeId"];
  export const NotifyFriendsOnGoLive: MappedModules["discord/modules/user_settings/UserSettings"]["NotifyFriendsOnGoLive"];
  export const QuietMode: MappedModules["discord/modules/user_settings/UserSettings"]["QuietMode"];
  export const ReactionNotifications: MappedModules["discord/modules/user_settings/UserSettings"]["ReactionNotifications"];
  export const RenderEmbeds: MappedModules["discord/modules/user_settings/UserSettings"]["RenderEmbeds"];
  export const RenderReactions: MappedModules["discord/modules/user_settings/UserSettings"]["RenderReactions"];
  export const RenderSpoilers: MappedModules["discord/modules/user_settings/UserSettings"]["RenderSpoilers"];
  export const RestrictedGuildIds: MappedModules["discord/modules/user_settings/UserSettings"]["RestrictedGuildIds"];
  export const RtcPanelShowVoiceStates: MappedModules["discord/modules/user_settings/UserSettings"]["RtcPanelShowVoiceStates"];
  export const ShowCommandSuggestions: MappedModules["discord/modules/user_settings/UserSettings"]["ShowCommandSuggestions"];
  export const ShowCurrentGame: MappedModules["discord/modules/user_settings/UserSettings"]["ShowCurrentGame"];
  export const SlayerSdkReceiveDmsInGame: MappedModules["discord/modules/user_settings/UserSettings"]["SlayerSdkReceiveDmsInGame"];
  export const SoundboardPickerCollapsedSections: MappedModules["discord/modules/user_settings/UserSettings"]["SoundboardPickerCollapsedSections"];
  export const SoundboardSettings: MappedModules["discord/modules/user_settings/UserSettings"]["SoundboardSettings"];
  export const SoundmojiVolume: MappedModules["discord/modules/user_settings/UserSettings"]["SoundmojiVolume"];
  export const Status: MappedModules["discord/modules/user_settings/UserSettings"]["Status"];
  export const StatusExpiresAtMs: MappedModules["discord/modules/user_settings/UserSettings"]["StatusExpiresAtMs"];
  export const StickerPickerCollapsedSections: MappedModules["discord/modules/user_settings/UserSettings"]["StickerPickerCollapsedSections"];
  export const TimestampHourCycle: MappedModules["discord/modules/user_settings/UserSettings"]["TimestampHourCycle"];
  export const TimezoneOffset: MappedModules["discord/modules/user_settings/UserSettings"]["TimezoneOffset"];
  export const UiDensity: MappedModules["discord/modules/user_settings/UserSettings"]["UiDensity"];
  export const UseLegacyChatInput: MappedModules["discord/modules/user_settings/UserSettings"]["UseLegacyChatInput"];
  export const UseRichChatInput: MappedModules["discord/modules/user_settings/UserSettings"]["UseRichChatInput"];
  export const UseThreadSidebar: MappedModules["discord/modules/user_settings/UserSettings"]["UseThreadSidebar"];
  export const ViewImageDescriptions: MappedModules["discord/modules/user_settings/UserSettings"]["ViewImageDescriptions"];
  export const ViewNsfwCommands: MappedModules["discord/modules/user_settings/UserSettings"]["ViewNsfwCommands"];
...
declare module "@moonlight-mod/wp/discord/utils/DateUtils" {
  import { MappedModules } from "@moonlight-mod/mappings";
  export const differenceInCalendarDays: MappedModules["discord/utils/DateUtils"]["differenceInCalendarDays"];
  export const differenceInDays: MappedModules["discord/utils/DateUtils"]["differenceInDays"];
  export const isSameDay: MappedModules["discord/utils/DateUtils"]["isSameDay"];
  export const isWithinInterval: MappedModules["discord/utils/DateUtils"]["isWithinInterval"];
  export const dateFormat: MappedModules["discord/utils/DateUtils"]["dateFormat"];
  export const calendarFormat: MappedModules["discord/utils/DateUtils"]["calendarFormat"];
  export const calendarFormatCompact: MappedModules["discord/utils/DateUtils"]["calendarFormatCompact"];
  export const accessibilityLabelCalendarFormat: MappedModules["discord/utils/DateUtils"]["accessibilityLabelCalendarFormat"];
  export const diffAsUnits: MappedModules["discord/utils/DateUtils"]["diffAsUnits"];
  export const unitsAsStrings: MappedModules["discord/utils/DateUtils"]["unitsAsStrings"];
  export const getMonthlyProgressPercentage: MappedModules["discord/utils/DateUtils"]["getMonthlyProgressPercentage"];
  export const getDaysRemainingInMonth: MappedModules["discord/utils/DateUtils"]["getDaysRemainingInMonth"];
  export const formatDateForDatetimeLocal: MappedModules["discord/utils/DateUtils"]["formatDateForDatetimeLocal"];
}
...
declare module "@moonlight-mod/wp/discord/utils/UserUtils" {
  import { MappedModules } from "@moonlight-mod/mappings";
  const _default: MappedModules["discord/utils/UserUtils"]["default"];
  export default _default;
  export const nameFromUser: MappedModules["discord/utils/UserUtils"]["nameFromUser"];
  export const getName: MappedModules["discord/utils/UserUtils"]["getName"];
  export const useName: MappedModules["discord/utils/UserUtils"]["useName"];
  export const humanizeStatus: MappedModules["discord/utils/UserUtils"]["humanizeStatus"];
  export const ageEligibleForPremiumUpsell: MappedModules["discord/utils/UserUtils"]["ageEligibleForPremiumUpsell"];
  export const isNewUser: MappedModules["discord/utils/UserUtils"]["isNewUser"];
  export const getUserTag: MappedModules["discord/utils/UserUtils"]["getUserTag"];
  export const useDirectMessageRecipient: MappedModules["discord/utils/UserUtils"]["useDirectMessageRecipient"];
  export const getUserIsStaff: MappedModules["discord/utils/UserUtils"]["getUserIsStaff"];
}
