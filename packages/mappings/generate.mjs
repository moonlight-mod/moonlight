...
const mappedTypes = {
  ...
  "discord/actions/UserProfileModalActionCreators": "UserProfileModalActionCreators",
  ...
  "discord/design/components/Avatar/web/Avatar": "Avatar",
  "discord/design/components/Avatar/web/AvatarConstants": "AvatarConstants",
  "discord/design/components/Breadcrumbs/web/Breadcrumbs": "Breadcrumbs",
  "discord/design/components/Button/web/Button": "Button",
  "discord/design/components/Button/web/TextButton": "TextButton",
  "discord/design/components/Clickable/web/Clickable": "Clickable",
  "discord/design/components/Dialog/web/Dialog": "Dialog",
  "discord/design/components/Divider/Divider": "Divider",
  "discord/design/components/Form/web/Field": "Field",
  ...
  "discord/design/components/Toast/web/Toast": "Toast",
  "discord/design/components/Toast/web/ToastAPI": "ToastAPI",
  "discord/design/components/Toast/web/ToastConstants": "ToastConstants",
  ...
  "discord/modules/icons/web/ArrowAngleLeftUpIcon": "ArrowAngleLeftUpIcon",
  "discord/modules/icons/web/ArrowAngleRightUpIcon": "ArrowAngleRightUpIcon",
  "discord/modules/icons/web/ArrowsUpDownIcon": "ArrowsUpDownIcon",
  "discord/modules/icons/web/BookCheckIcon": "BookCheckIcon",
  "discord/modules/icons/web/ChannelListIcon": "ChannelListIcon",
  "discord/modules/icons/web/ChevronSmallDownIcon": "ChevronSmallDownIcon",
  "discord/modules/icons/web/ChevronSmallUpIcon": "ChevronSmallUpIcon",
  "discord/modules/icons/web/CircleInformationIcon": "CircleInformationIcon",
  ...
  "discord/modules/icons/web/CopyIcon": "CopyIcon",
  "discord/modules/icons/web/DownloadIcon": "DownloadIcon",
  "discord/modules/icons/web/FullscreenEnterIcon": "FullscreenEnterIcon",
  "discord/modules/icons/web/GameControllerIcon": "GameControllerIcon",
  "discord/modules/icons/web/GlobeEarthIcon": "GlobeEarthIcon",
  "discord/modules/icons/web/HeartIcon": "HeartIcon",
  "discord/modules/icons/web/LinkIcon": "LinkIcon",
  "discord/modules/icons/web/MaximizeIcon": "MaximizeIcon",
  "discord/modules/icons/web/MinusIcon": "MinusIcon",
  ...
  "discord/modules/icons/web/PlusLargeIcon": "PlusLargeIcon",
  "discord/modules/icons/web/RetryIcon": "RetryIcon",
  "discord/modules/icons/web/ScienceIcon": "ScienceIcon",
  "discord/modules/icons/web/ScreenIcon": "ScreenIcon",
  "discord/modules/icons/web/StarIcon": "StarIcon",
  "discord/modules/icons/web/TrashIcon": "TrashIcon",
  "discord/modules/icons/web/VrHeadsetIcon": "VrHeadsetIcon",
  "discord/modules/icons/web/WarningIcon": "WarningIcon",
  "discord/modules/icons/web/WindowLaunchIcon": "WindowLaunchIcon",
  "discord/modules/icons/web/WindowTopOutlineIcon": "WindowTopOutlineIcon",
  "discord/modules/icons/web/XLargeIcon": "XLargeIcon",
  "discord/modules/icons/web/XSmallIcon": "XSmallIcon",
...
function generateTypes() {
  ...
  for (const path of paths) {
    ...
    str += `import type ${type} from "./mappings/${path}";\n`;
  }
