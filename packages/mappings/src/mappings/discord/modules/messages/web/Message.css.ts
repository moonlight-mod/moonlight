...
register((moonmap) => {
  ...
  moonmap.register({
    ...
    process({ id }) {
      ...
      mapCssExport(moonmap, name, "preview");
      ...
      mapCssExport(moonmap, name, "botTag");
      ...
      mapCssExport(moonmap, name, "gradient");
      mapCssExport(moonmap, name, "header");
      mapCssExport(moonmap, name, "withDisplayNameStyles");
      ...
      mapCssExport(moonmap, name, "usernameColorOnName");
